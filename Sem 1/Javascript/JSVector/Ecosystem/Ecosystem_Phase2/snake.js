...
Snake.prototype.render = function(){
  ...
  ctx.arc(this.loc.x-1,this.loc.y-1,this.rad,0,2*Math.PI);
  ctx.arc(this.loc.x-2,this.loc.y-2,this.rad,0,2*Math.PI);
  ctx.arc(this.loc.x-3,this.loc.y-3,this.rad,0,2*Math.PI);
