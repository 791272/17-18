function Mover(){
  ...
  //   this.c = "green";
  // }
  //this.c = 'rgb(' + Math.floor(Math.random()*1000) + ',' + Math.floor(Math.random()*) + ',' + Math.floor(Math.random()*255) + ')';
  //this.c = 'rgba(' + Math.floor(Math.random()*1) + ',' + Math.floor(Math.random()*1) + ',' + Math.floor(Math.random()*1) + ',' + Math.random() + ')';
  this.c = 'rgba(' + Math.floor(Math.random()*1) + ',' + Math.floor(Math.random()*1) + ',' + Math.floor(Math.random()*1) + ',' + ((Math.random()*1.2)-0.8) + ')';
  //this.c = 'rgba(' + Math.floor(Math.random()*10000000) + ',' + Math.floor(Math.random()*10000000) + ',' + Math.floor(Math.random()*10000000) + ',' + ((Math.random()*1.2)-0.8) + ')';
  //this.c = 'rgba('255,255,255 ',' + ((Math.random()*1.2)-0.8) + ')';
}
...
Mover.prototype.render = function(){
  ...
  //ctx.arc(this.loc.x-25,this.loc.y,this.rad,0,2*Math.PI);
